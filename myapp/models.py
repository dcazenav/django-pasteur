...
class Feuille_calcul(models.Model):
    ...
    date_etalonnage = models.DateField(auto_now=False, verbose_name="Date de l'étalonnage")
    ...
    var4_mest = models.DateField(auto_now=False, verbose_name="date de préparation de la solution de cellulose microcristalline")
    var1_ntk = models.DateField(auto_now=False, verbose_name="Date de préparation du mélange catalyseur")
    ...
    var1_dbo_avec_dilution = models.DateField(auto_now=False, verbose_name="date de préparation de l'eau de dilution")
    ...
    var1_dbo_sans_dilution = models.DateField(auto_now=False, verbose_name="Date de préparation de la solution de lavage")
    ...
    var3_chlorophylle_lorenzen = models.DateField(auto_now=False, verbose_name="Date de préparation de l'HCI")
    var1_dco = models.DateField(auto_now=False, verbose_name="date de minéralisation")
    var2_dco = models.DateField(auto_now=False, verbose_name="date de titration")
