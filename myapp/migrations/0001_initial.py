# Generated by Django 2.1.7 on 2019-07-04 16:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(default='', max_length=100, verbose_name='codification')),
                ('date_rev', models.DateField(default='', verbose_name='date_revision')),
                ('revision', models.CharField(default='', max_length=100, verbose_name='révision')),
                ('intitule', models.CharField(default='', max_length=100, verbose_name='Intitulé')),
            ],
        ),
        migrations.CreateModel(
            name='Echantillon',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codification', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.Codification')),
